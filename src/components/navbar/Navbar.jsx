  ...
  return (
    <nav className="bg-barber-primary fixed w-full z-20 top-0 start-0">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          <ul
            className="flex flex-col p-4 lg:p-0 mt-4 font-medium border 
          ...
          >
            <li>
              <button
                className="block py-2 px-3 text-barber-light hover:text-barber-accent lg:p-0 "
